...
namespace GISharp.Core.Test.GLib
{
    ...
    public class SListTests
    {
        ...
        {
            var list = new SList<OpaqueInt> ().Append (null);
        ...
        public void TestRemoveLink ()
        {
            ...
            list = new SList<OpaqueInt> ().Append (null);
            // calling remove on unowned pointer is not allowed
        ...
        public void TestConcat ()
        {
            ...
            Assert.That (() => SList<OpaqueInt>.Concat (list1, list2),
                Throws.InvalidOperationException);
            // make sure null values are allowed
            newList = SList<OpaqueInt>.Concat (null, null);
            Assert.That (newList.Length, Is.EqualTo (0));
            Assert.That (newList.Owned, Is.True);
        }
        ...
        public void TestFind ()
        {
            ...
            // calling on unowned pointer is not allowed
            Assert.That (() => list.Last.Find (new OpaqueInt (1)),
                Throws.InvalidOperationException);
        }
        ...
        public void TestFindCustom ()
        {
            ...
            Assert.That (() => list.FindCustom (new OpaqueInt (1), null),
                Throws.InstanceOf<ArgumentNullException> ());
            // calling on unowned pointer is not allowed
            Assert.That (() => list.Last.FindCustom (new OpaqueInt (1), compareFunc),
                Throws.InvalidOperationException);
        }
        ...
        public void TestPosition ()
        {
            ...
            position = list.Position (new SList<OpaqueInt> ()
                .Append (new OpaqueInt (1)));
