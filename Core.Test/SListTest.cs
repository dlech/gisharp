...
namespace Core.Test
{
    ...
    public class SListTest
    {
        ...
        {
            var list = new SList<TestWrappedNative> ();
        ...
        {
            var list = new SList<TestWrappedNative> ().Append (null);
        ...
        public void TestRemoveLink ()
        {
            ...
            list = new SList<TestWrappedNative> ().Append (null);
            // calling remove on unowned pointer is not allowed
        ...
        public void TestConcat ()
        {
            ...
            Assert.That (() => SList<TestWrappedNative>.Concat (list1, list2),
                Throws.InvalidOperationException);
            // make sure null values are allowed
            newList = SList<TestWrappedNative>.Concat (null, null);
            Assert.That (newList.Length, Is.EqualTo (0));
            Assert.That (newList.Owned, Is.True);
        }
        ...
        public void TestFind ()
        {
            ...
            // calling on unowned pointer is not allowed
            Assert.That (() => list.Last.Find (new TestWrappedNative (1)),
                Throws.InvalidOperationException);
        }
        ...
        public void TestFindCustom ()
        {
            ...
            Assert.That (() => list.FindCustom (new TestWrappedNative (1), null),
                Throws.InstanceOf<ArgumentNullException> ());
            // calling on unowned pointer is not allowed
            Assert.That (() => list.Last.FindCustom (new TestWrappedNative (1), compareFunc),
                Throws.InvalidOperationException);
        }
        ...
        public void TestPosition ()
        {
            ...
            position = list.Position (new SList<TestWrappedNative> ()
                .Append (new TestWrappedNative (1)));
