...
GISharp.Lib.Gio.File.UnmanagedStruct* file);
        ...
        public static unsafe class DupMarshal
        {
            ...
            {
                GISharp.Lib.Gio.File.UnmanagedStruct* unmanagedDup(GISharp.Lib.Gio.File.UnmanagedStruct* file_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var doDup = (_Dup)methodInfo.CreateDelegate(typeof(_Dup), file);
                        var ret = doDup();
                    ...
                    return default(GISharp.Lib.Gio.File.UnmanagedStruct*);
                }
...
GISharp.Lib.Gio.File.UnmanagedStruct* file);
        ...
        public static unsafe class HashMarshal
        {
            ...
            {
                uint unmanagedHash(GISharp.Lib.Gio.File.UnmanagedStruct* file_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var doHash = (_Hash)methodInfo.CreateDelegate(typeof(_Hash), file);
                        var ret = doHash();
                        var ret_ = (uint)ret;
                        return ret_;
                    }
...
GISharp.Lib.Gio.File.UnmanagedStruct* file2);
        ...
        public static unsafe class EqualMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedEqual(GISharp.Lib.Gio.File.UnmanagedStruct* file1_, GISharp.Lib.Gio.File.UnmanagedStruct* file2_)
                {
                    try
                    {
                        var file1 = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file1_, GISharp.Runtime.Transfer.None)!;
                        var file2 = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file2_, GISharp.Runtime.Transfer.None)!;
                        var doEqual = (_Equal)methodInfo.CreateDelegate(typeof(_Equal), file1);
...
GISharp.Lib.Gio.File.UnmanagedStruct* file);
        ...
        public static unsafe class IsNativeMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedIsNative(GISharp.Lib.Gio.File.UnmanagedStruct* file_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var doIsNative = (_IsNative)methodInfo.CreateDelegate(typeof(_IsNative), file);
                        var ret = doIsNative();
                        var ret_ = GISharp.Runtime.BooleanExtensions.ToBoolean(ret);
                        return ret_;
                    }
...
byte* uriScheme);
        ...
        public static unsafe class HasUriSchemeMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedHasUriScheme(GISharp.Lib.Gio.File.UnmanagedStruct* file_, byte* uriScheme_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
...
GISharp.Lib.Gio.File.UnmanagedStruct* file);
        ...
        public static unsafe class GetUriSchemeMarshal
        {
            ...
            {
                byte* unmanagedGetUriScheme(GISharp.Lib.Gio.File.UnmanagedStruct* file_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var doGetUriScheme = (_GetUriScheme)methodInfo.CreateDelegate(typeof(_GetUriScheme), file);
                        var ret = doGetUriScheme();
                        var ret_ = (byte*)(ret?.Take() ?? System.IntPtr.Zero);
                        return ret_;
                    }
                    catch (System.Exception ex)
                    {
...
GISharp.Lib.Gio.File.UnmanagedStruct* file);
        ...
        public static unsafe class GetBasenameMarshal
        {
            ...
            {
                byte* unmanagedGetBasename(GISharp.Lib.Gio.File.UnmanagedStruct* file_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var doGetBasename = (_GetBasename)methodInfo.CreateDelegate(typeof(_GetBasename), file);
...
GISharp.Lib.Gio.File.UnmanagedStruct* file);
        ...
        public static unsafe class GetPathMarshal
        {
            ...
            {
                byte* unmanagedGetPath(GISharp.Lib.Gio.File.UnmanagedStruct* file_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var doGetPath = (_GetPath)methodInfo.CreateDelegate(typeof(_GetPath), file);
                        var ret = doGetPath();
                        var ret_ = (byte*)(ret?.Take() ?? System.IntPtr.Zero);
                        return ret_;
                    }
...
GISharp.Lib.Gio.File.UnmanagedStruct* file);
        ...
        public static unsafe class GetUriMarshal
        {
            ...
            {
                byte* unmanagedGetUri(GISharp.Lib.Gio.File.UnmanagedStruct* file_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var doGetUri = (_GetUri)methodInfo.CreateDelegate(typeof(_GetUri), file);
                        var ret = doGetUri();
...
GISharp.Lib.Gio.File.UnmanagedStruct* file);
        ...
        public static unsafe class GetParseNameMarshal
        {
            ...
            {
                byte* unmanagedGetParseName(GISharp.Lib.Gio.File.UnmanagedStruct* file_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var doGetParseName = (_GetParseName)methodInfo.CreateDelegate(typeof(_GetParseName), file);
...
GISharp.Lib.Gio.File.UnmanagedStruct* file);
        ...
        public static unsafe class GetParentMarshal
        {
            ...
            {
                GISharp.Lib.Gio.File.UnmanagedStruct* unmanagedGetParent(GISharp.Lib.Gio.File.UnmanagedStruct* file_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var doGetParent = (_GetParent)methodInfo.CreateDelegate(typeof(_GetParent), file);
                        var ret = doGetParent();
                        var ret_ = (GISharp.Lib.Gio.File.UnmanagedStruct*)(ret?.Take() ?? System.IntPtr.Zero);
                        return ret_;
                    }
                    catch (System.Exception ex)
                    {
...
GISharp.Lib.Gio.File.UnmanagedStruct* file);
        ...
        public static unsafe class PrefixMatchesMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedPrefixMatches(GISharp.Lib.Gio.File.UnmanagedStruct* prefix_, GISharp.Lib.Gio.File.UnmanagedStruct* file_)
                {
                    try
                    {
                        var prefix = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)prefix_, GISharp.Runtime.Transfer.None)!;
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var doPrefixMatches = (_PrefixMatches)methodInfo.CreateDelegate(typeof(_PrefixMatches), prefix);
...
GISharp.Lib.Gio.File.UnmanagedStruct* descendant);
        ...
        public static unsafe class GetRelativePathMarshal
        {
            ...
            {
                byte* unmanagedGetRelativePath(GISharp.Lib.Gio.File.UnmanagedStruct* parent_, GISharp.Lib.Gio.File.UnmanagedStruct* descendant_)
                {
                    try
                    {
                        var parent = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)parent_, GISharp.Runtime.Transfer.None)!;
                        var descendant = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)descendant_, GISharp.Runtime.Transfer.None)!;
                        var doGetRelativePath = (_GetRelativePath)methodInfo.CreateDelegate(typeof(_GetRelativePath), parent);
...
byte* relativePath);
        ...
        public static unsafe class ResolveRelativePathMarshal
        {
            ...
            {
                GISharp.Lib.Gio.File.UnmanagedStruct* unmanagedResolveRelativePath(GISharp.Lib.Gio.File.UnmanagedStruct* file_, byte* relativePath_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class GetChildForDisplayNameMarshal
        {
            ...
            {
                GISharp.Lib.Gio.File.UnmanagedStruct* unmanagedGetChildForDisplayName(GISharp.Lib.Gio.File.UnmanagedStruct* file_, byte* displayName_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
            ...
            public static UnmanagedEnumerateChildrenAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedEnumerateChildrenAsync(GISharp.Lib.Gio.File.UnmanagedStruct* file_, byte* attributes_, GISharp.Lib.Gio.FileQueryInfoFlags flags_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var doEnumerateChildrenAsync = (_EnumerateChildrenAsync)methodInfo.CreateDelegate(typeof(_EnumerateChildrenAsync), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class QueryInfoMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileInfo.UnmanagedStruct* unmanagedQueryInfo(GISharp.Lib.Gio.File.UnmanagedStruct* file_, byte* attributes_, GISharp.Lib.Gio.FileQueryInfoFlags flags_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                    ...
                    return default(GISharp.Lib.Gio.FileInfo.UnmanagedStruct*);
                }
            ...
            public static UnmanagedQueryInfoAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedQueryInfoAsync(GISharp.Lib.Gio.File.UnmanagedStruct* file_, byte* attributes_, GISharp.Lib.Gio.FileQueryInfoFlags flags_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doQueryInfoAsync = (_QueryInfoAsync)methodInfo.CreateDelegate(typeof(_QueryInfoAsync), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class QueryInfoFinishMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileInfo.UnmanagedStruct* unmanagedQueryInfoFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* res_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        ...
                        var doQueryInfoFinish = (_QueryInfoFinish)methodInfo.CreateDelegate(typeof(_QueryInfoFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class QueryFilesystemInfoMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileInfo.UnmanagedStruct* unmanagedQueryFilesystemInfo(GISharp.Lib.Gio.File.UnmanagedStruct* file_, byte* attributes_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
            ...
            public static UnmanagedQueryFilesystemInfoAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedQueryFilesystemInfoAsync(GISharp.Lib.Gio.File.UnmanagedStruct* file_, byte* attributes_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doQueryFilesystemInfoAsync = (_QueryFilesystemInfoAsync)methodInfo.CreateDelegate(typeof(_QueryFilesystemInfoAsync), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class QueryFilesystemInfoFinishMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileInfo.UnmanagedStruct* unmanagedQueryFilesystemInfoFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* res_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var res = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)res_, GISharp.Runtime.Transfer.None)!;
                        var doQueryFilesystemInfoFinish = (_QueryFilesystemInfoFinish)methodInfo.CreateDelegate(typeof(_QueryFilesystemInfoFinish), file);
            ...
            public static UnmanagedFindEnclosingMountAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedFindEnclosingMountAsync(GISharp.Lib.Gio.File.UnmanagedStruct* file_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doFindEnclosingMountAsync = (_FindEnclosingMountAsync)methodInfo.CreateDelegate(typeof(_FindEnclosingMountAsync), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class SetDisplayNameMarshal
        {
            ...
            {
                GISharp.Lib.Gio.File.UnmanagedStruct* unmanagedSetDisplayName(GISharp.Lib.Gio.File.UnmanagedStruct* file_, byte* displayName_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
            ...
            public static UnmanagedSetDisplayNameAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedSetDisplayNameAsync(GISharp.Lib.Gio.File.UnmanagedStruct* file_, byte* displayName_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doSetDisplayNameAsync = (_SetDisplayNameAsync)methodInfo.CreateDelegate(typeof(_SetDisplayNameAsync), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class SetDisplayNameFinishMarshal
        {
            ...
            {
                GISharp.Lib.Gio.File.UnmanagedStruct* unmanagedSetDisplayNameFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* res_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var res = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)res_, GISharp.Runtime.Transfer.None)!;
                        var doSetDisplayNameFinish = (_SetDisplayNameFinish)methodInfo.CreateDelegate(typeof(_SetDisplayNameFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class QuerySettableAttributesMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileAttributeInfoList.UnmanagedStruct* unmanagedQuerySettableAttributes(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doQuerySettableAttributes = (_QuerySettableAttributes)methodInfo.CreateDelegate(typeof(_QuerySettableAttributes), file);
                        var ret = doQuerySettableAttributes(cancellable);
                        var ret_ = (GISharp.Lib.Gio.FileAttributeInfoList.UnmanagedStruct*)ret.Take();
                        return ret_;
                    }
                    catch (GISharp.Lib.GLib.Error.Exception ex)
                    {
                    ...
                    return default(GISharp.Lib.Gio.FileAttributeInfoList.UnmanagedStruct*);
                }
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class QueryWritableNamespacesMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileAttributeInfoList.UnmanagedStruct* unmanagedQueryWritableNamespaces(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doQueryWritableNamespaces = (_QueryWritableNamespaces)methodInfo.CreateDelegate(typeof(_QueryWritableNamespaces), file);
            ...
            public static UnmanagedSetAttribute Create(System.Reflection.MethodInfo methodInfo)
            {
                GISharp.Runtime.Boolean unmanagedSetAttribute(GISharp.Lib.Gio.File.UnmanagedStruct* file_, byte* attribute_, GISharp.Lib.Gio.FileAttributeType type_, System.IntPtr valueP_, GISharp.Lib.Gio.FileQueryInfoFlags flags_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        ...
                        var flags = (GISharp.Lib.Gio.FileQueryInfoFlags)flags_;
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doSetAttribute = (_SetAttribute)methodInfo.CreateDelegate(typeof(_SetAttribute), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class SetAttributesFromInfoMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedSetAttributesFromInfo(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.FileInfo.UnmanagedStruct* info_, GISharp.Lib.Gio.FileQueryInfoFlags flags_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var info = GISharp.Lib.Gio.FileInfo.GetInstance<GISharp.Lib.Gio.FileInfo>((System.IntPtr)info_, GISharp.Runtime.Transfer.None)!;
                        var flags = (GISharp.Lib.Gio.FileQueryInfoFlags)flags_;
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doSetAttributesFromInfo = (_SetAttributesFromInfo)methodInfo.CreateDelegate(typeof(_SetAttributesFromInfo), file);
            ...
            public static UnmanagedSetAttributesAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedSetAttributesAsync(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.FileInfo.UnmanagedStruct* info_, GISharp.Lib.Gio.FileQueryInfoFlags flags_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doSetAttributesAsync = (_SetAttributesAsync)methodInfo.CreateDelegate(typeof(_SetAttributesAsync), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class SetAttributesFinishMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedSetAttributesFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* result_, GISharp.Lib.Gio.FileInfo.UnmanagedStruct** info_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        ...
                        var doSetAttributesFinish = (_SetAttributesFinish)methodInfo.CreateDelegate(typeof(_SetAttributesFinish), file);
                        doSetAttributesFinish(result,out var info);
                        *info_ = (GISharp.Lib.Gio.FileInfo.UnmanagedStruct*)info.Take();
                        return GISharp.Runtime.Boolean.True;
                    }
                    catch (GISharp.Lib.GLib.Error.Exception ex)
                    {
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class ReadFnMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileInputStream.UnmanagedStruct* unmanagedReadFn(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doReadFn = (_ReadFn)methodInfo.CreateDelegate(typeof(_ReadFn), file);
                        var ret = doReadFn(cancellable);
                        var ret_ = (GISharp.Lib.Gio.FileInputStream.UnmanagedStruct*)ret.Take();
                        return ret_;
                    }
                    catch (GISharp.Lib.GLib.Error.Exception ex)
                    {
                    ...
                    return default(GISharp.Lib.Gio.FileInputStream.UnmanagedStruct*);
                }
            ...
            public static UnmanagedReadAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedReadAsync(GISharp.Lib.Gio.File.UnmanagedStruct* file_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doReadAsync = (_ReadAsync)methodInfo.CreateDelegate(typeof(_ReadAsync), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class ReadFinishMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileInputStream.UnmanagedStruct* unmanagedReadFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* res_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var res = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)res_, GISharp.Runtime.Transfer.None)!;
                        var doReadFinish = (_ReadFinish)methodInfo.CreateDelegate(typeof(_ReadFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class AppendToMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* unmanagedAppendTo(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.FileCreateFlags flags_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        ...
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doAppendTo = (_AppendTo)methodInfo.CreateDelegate(typeof(_AppendTo), file);
                        var ret = doAppendTo(flags, cancellable);
                        var ret_ = (GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct*)ret.Take();
                        return ret_;
                    }
                    catch (GISharp.Lib.GLib.Error.Exception ex)
                    {
                    ...
                    return default(GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct*);
                }
            ...
            public static UnmanagedAppendToAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedAppendToAsync(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.FileCreateFlags flags_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doAppendToAsync = (_AppendToAsync)methodInfo.CreateDelegate(typeof(_AppendToAsync), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class AppendToFinishMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* unmanagedAppendToFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* res_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var res = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)res_, GISharp.Runtime.Transfer.None)!;
                        var doAppendToFinish = (_AppendToFinish)methodInfo.CreateDelegate(typeof(_AppendToFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class CreateMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* unmanagedCreate(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.FileCreateFlags flags_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var flags = (GISharp.Lib.Gio.FileCreateFlags)flags_;
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doCreate = (_Create)methodInfo.CreateDelegate(typeof(_Create), file);
            ...
            public static UnmanagedCreateAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedCreateAsync(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.FileCreateFlags flags_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doCreateAsync = (_CreateAsync)methodInfo.CreateDelegate(typeof(_CreateAsync), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class CreateFinishMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* unmanagedCreateFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* res_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var res = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)res_, GISharp.Runtime.Transfer.None)!;
                        var doCreateFinish = (_CreateFinish)methodInfo.CreateDelegate(typeof(_CreateFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class ReplaceMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* unmanagedReplace(GISharp.Lib.Gio.File.UnmanagedStruct* file_, byte* etag_, GISharp.Runtime.Boolean makeBackup_, GISharp.Lib.Gio.FileCreateFlags flags_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        ...
                        var flags = (GISharp.Lib.Gio.FileCreateFlags)flags_;
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doReplace = (_Replace)methodInfo.CreateDelegate(typeof(_Replace), file);
            ...
            public static UnmanagedReplaceAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedReplaceAsync(GISharp.Lib.Gio.File.UnmanagedStruct* file_, byte* etag_, GISharp.Runtime.Boolean makeBackup_, GISharp.Lib.Gio.FileCreateFlags flags_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doReplaceAsync = (_ReplaceAsync)methodInfo.CreateDelegate(typeof(_ReplaceAsync), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class ReplaceFinishMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* unmanagedReplaceFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* res_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var res = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)res_, GISharp.Runtime.Transfer.None)!;
                        var doReplaceFinish = (_ReplaceFinish)methodInfo.CreateDelegate(typeof(_ReplaceFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class DeleteFileMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedDeleteFile(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doDeleteFile = (_DeleteFile)methodInfo.CreateDelegate(typeof(_DeleteFile), file);
            ...
            public static UnmanagedDeleteFileAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedDeleteFileAsync(GISharp.Lib.Gio.File.UnmanagedStruct* file_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doDeleteFileAsync = (_DeleteFileAsync)methodInfo.CreateDelegate(typeof(_DeleteFileAsync), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class DeleteFileFinishMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedDeleteFileFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* result_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var result = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)result_, GISharp.Runtime.Transfer.None)!;
                        var doDeleteFileFinish = (_DeleteFileFinish)methodInfo.CreateDelegate(typeof(_DeleteFileFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class TrashMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedTrash(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doTrash = (_Trash)methodInfo.CreateDelegate(typeof(_Trash), file);
                        doTrash(cancellable);
                        return GISharp.Runtime.Boolean.True;
                    }
                    catch (GISharp.Lib.GLib.Error.Exception ex)
            ...
            public static UnmanagedTrashAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedTrashAsync(GISharp.Lib.Gio.File.UnmanagedStruct* file_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doTrashAsync = (_TrashAsync)methodInfo.CreateDelegate(typeof(_TrashAsync), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class TrashFinishMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedTrashFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* result_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var result = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)result_, GISharp.Runtime.Transfer.None)!;
                        var doTrashFinish = (_TrashFinish)methodInfo.CreateDelegate(typeof(_TrashFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class MakeDirectoryMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedMakeDirectory(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doMakeDirectory = (_MakeDirectory)methodInfo.CreateDelegate(typeof(_MakeDirectory), file);
            ...
            public static UnmanagedMakeDirectoryAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedMakeDirectoryAsync(GISharp.Lib.Gio.File.UnmanagedStruct* file_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doMakeDirectoryAsync = (_MakeDirectoryAsync)methodInfo.CreateDelegate(typeof(_MakeDirectoryAsync), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class MakeDirectoryFinishMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedMakeDirectoryFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* result_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var result = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)result_, GISharp.Runtime.Transfer.None)!;
                        var doMakeDirectoryFinish = (_MakeDirectoryFinish)methodInfo.CreateDelegate(typeof(_MakeDirectoryFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class MakeSymbolicLinkMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedMakeSymbolicLink(GISharp.Lib.Gio.File.UnmanagedStruct* file_, byte* symlinkValue_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
            ...
            public static UnmanagedCopy Create(System.Reflection.MethodInfo methodInfo)
            {
                GISharp.Runtime.Boolean unmanagedCopy(GISharp.Lib.Gio.File.UnmanagedStruct* source_, GISharp.Lib.Gio.File.UnmanagedStruct* destination_, GISharp.Lib.Gio.FileCopyFlags flags_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<long, long, System.IntPtr, void> progressCallback_, System.IntPtr progressCallbackData_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        ...
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doCopy = (_Copy)methodInfo.CreateDelegate(typeof(_Copy), source);
            ...
            public static UnmanagedCopyAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedCopyAsync(GISharp.Lib.Gio.File.UnmanagedStruct* source_, GISharp.Lib.Gio.File.UnmanagedStruct* destination_, GISharp.Lib.Gio.FileCopyFlags flags_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<long, long, System.IntPtr, void> progressCallback_, System.IntPtr progressCallbackData_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doCopyAsync = (_CopyAsync)methodInfo.CreateDelegate(typeof(_CopyAsync), source);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class CopyFinishMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedCopyFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* res_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var res = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)res_, GISharp.Runtime.Transfer.None)!;
                        var doCopyFinish = (_CopyFinish)methodInfo.CreateDelegate(typeof(_CopyFinish), file);
                        doCopyFinish(res);
                        return GISharp.Runtime.Boolean.True;
                    }
                    catch (GISharp.Lib.GLib.Error.Exception ex)
            ...
            public static UnmanagedMove Create(System.Reflection.MethodInfo methodInfo)
            {
                GISharp.Runtime.Boolean unmanagedMove(GISharp.Lib.Gio.File.UnmanagedStruct* source_, GISharp.Lib.Gio.File.UnmanagedStruct* destination_, GISharp.Lib.Gio.FileCopyFlags flags_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<long, long, System.IntPtr, void> progressCallback_, System.IntPtr progressCallbackData_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        ...
                        var progressCallback = progressCallback_ is null ? default(GISharp.Lib.Gio.FileProgressCallback) : GISharp.Lib.Gio.FileProgressCallbackMarshal.FromPointer(progressCallback_, progressCallbackData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doMove = (_Move)methodInfo.CreateDelegate(typeof(_Move), source);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class MountMountableFinishMarshal
        {
            ...
            {
                GISharp.Lib.Gio.File.UnmanagedStruct* unmanagedMountMountableFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* result_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var result = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)result_, GISharp.Runtime.Transfer.None)!;
                        var doMountMountableFinish = (_MountMountableFinish)methodInfo.CreateDelegate(typeof(_MountMountableFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class UnmountMountableFinishMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedUnmountMountableFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* result_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var result = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)result_, GISharp.Runtime.Transfer.None)!;
                        var doUnmountMountableFinish = (_UnmountMountableFinish)methodInfo.CreateDelegate(typeof(_UnmountMountableFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class EjectMountableFinishMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedEjectMountableFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* result_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var result = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)result_, GISharp.Runtime.Transfer.None)!;
                        var doEjectMountableFinish = (_EjectMountableFinish)methodInfo.CreateDelegate(typeof(_EjectMountableFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class MountEnclosingVolumeFinishMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedMountEnclosingVolumeFinish(GISharp.Lib.Gio.File.UnmanagedStruct* location_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* result_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var location = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)location_, GISharp.Runtime.Transfer.None)!;
                        var result = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)result_, GISharp.Runtime.Transfer.None)!;
                        var doMountEnclosingVolumeFinish = (_MountEnclosingVolumeFinish)methodInfo.CreateDelegate(typeof(_MountEnclosingVolumeFinish), location);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class OpenReadwriteMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileIOStream.UnmanagedStruct* unmanagedOpenReadwrite(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doOpenReadwrite = (_OpenReadwrite)methodInfo.CreateDelegate(typeof(_OpenReadwrite), file);
                        var ret = doOpenReadwrite(cancellable);
                        var ret_ = (GISharp.Lib.Gio.FileIOStream.UnmanagedStruct*)ret.Take();
                        return ret_;
                    }
                    catch (GISharp.Lib.GLib.Error.Exception ex)
                    {
                    ...
                    return default(GISharp.Lib.Gio.FileIOStream.UnmanagedStruct*);
                }
            ...
            public static UnmanagedOpenReadwriteAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedOpenReadwriteAsync(GISharp.Lib.Gio.File.UnmanagedStruct* file_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doOpenReadwriteAsync = (_OpenReadwriteAsync)methodInfo.CreateDelegate(typeof(_OpenReadwriteAsync), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class OpenReadwriteFinishMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileIOStream.UnmanagedStruct* unmanagedOpenReadwriteFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* res_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var res = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)res_, GISharp.Runtime.Transfer.None)!;
                        var doOpenReadwriteFinish = (_OpenReadwriteFinish)methodInfo.CreateDelegate(typeof(_OpenReadwriteFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class CreateReadwriteMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileIOStream.UnmanagedStruct* unmanagedCreateReadwrite(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.FileCreateFlags flags_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var flags = (GISharp.Lib.Gio.FileCreateFlags)flags_;
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doCreateReadwrite = (_CreateReadwrite)methodInfo.CreateDelegate(typeof(_CreateReadwrite), file);
            ...
            public static UnmanagedCreateReadwriteAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedCreateReadwriteAsync(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.FileCreateFlags flags_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doCreateReadwriteAsync = (_CreateReadwriteAsync)methodInfo.CreateDelegate(typeof(_CreateReadwriteAsync), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class CreateReadwriteFinishMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileIOStream.UnmanagedStruct* unmanagedCreateReadwriteFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* res_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var res = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)res_, GISharp.Runtime.Transfer.None)!;
                        var doCreateReadwriteFinish = (_CreateReadwriteFinish)methodInfo.CreateDelegate(typeof(_CreateReadwriteFinish), file);
            ...
            public static UnmanagedReplaceReadwrite Create(System.Reflection.MethodInfo methodInfo)
            {
                GISharp.Lib.Gio.FileIOStream.UnmanagedStruct* unmanagedReplaceReadwrite(GISharp.Lib.Gio.File.UnmanagedStruct* file_, byte* etag_, GISharp.Runtime.Boolean makeBackup_, GISharp.Lib.Gio.FileCreateFlags flags_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        ...
                        var flags = (GISharp.Lib.Gio.FileCreateFlags)flags_;
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doReplaceReadwrite = (_ReplaceReadwrite)methodInfo.CreateDelegate(typeof(_ReplaceReadwrite), file);
            ...
            public static UnmanagedReplaceReadwriteAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedReplaceReadwriteAsync(GISharp.Lib.Gio.File.UnmanagedStruct* file_, byte* etag_, GISharp.Runtime.Boolean makeBackup_, GISharp.Lib.Gio.FileCreateFlags flags_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doReplaceReadwriteAsync = (_ReplaceReadwriteAsync)methodInfo.CreateDelegate(typeof(_ReplaceReadwriteAsync), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class ReplaceReadwriteFinishMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileIOStream.UnmanagedStruct* unmanagedReplaceReadwriteFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* res_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var res = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)res_, GISharp.Runtime.Transfer.None)!;
                        var doReplaceReadwriteFinish = (_ReplaceReadwriteFinish)methodInfo.CreateDelegate(typeof(_ReplaceReadwriteFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class StartMountableFinishMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedStartMountableFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* result_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var result = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)result_, GISharp.Runtime.Transfer.None)!;
                        var doStartMountableFinish = (_StartMountableFinish)methodInfo.CreateDelegate(typeof(_StartMountableFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class StopMountableFinishMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedStopMountableFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* result_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var result = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)result_, GISharp.Runtime.Transfer.None)!;
                        var doStopMountableFinish = (_StopMountableFinish)methodInfo.CreateDelegate(typeof(_StopMountableFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class UnmountMountableWithOperationFinishMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedUnmountMountableWithOperationFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* result_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var result = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)result_, GISharp.Runtime.Transfer.None)!;
                        var doUnmountMountableWithOperationFinish = (_UnmountMountableWithOperationFinish)methodInfo.CreateDelegate(typeof(_UnmountMountableWithOperationFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class EjectMountableWithOperationFinishMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedEjectMountableWithOperationFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* result_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var result = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)result_, GISharp.Runtime.Transfer.None)!;
                        var doEjectMountableWithOperationFinish = (_EjectMountableWithOperationFinish)methodInfo.CreateDelegate(typeof(_EjectMountableWithOperationFinish), file);
...
System.IntPtr userData);
        ...
        public static unsafe class PollMountableMarshal
        {
            ...
            {
                void unmanagedPollMountable(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var callback = callback_ is null ? default(GISharp.Lib.Gio.AsyncReadyCallback) : GISharp.Lib.Gio.AsyncReadyCallbackMarshal.FromPointer(callback_, userData_);
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doPollMountable = (_PollMountable)methodInfo.CreateDelegate(typeof(_PollMountable), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class PollMountableFinishMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedPollMountableFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* result_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var result = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)result_, GISharp.Runtime.Transfer.None)!;
                        var doPollMountableFinish = (_PollMountableFinish)methodInfo.CreateDelegate(typeof(_PollMountableFinish), file);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class MeasureDiskUsageFinishMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedMeasureDiskUsageFinish(GISharp.Lib.Gio.File.UnmanagedStruct* file_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* result_, ulong* diskUsage_, ulong* numDirs_, ulong* numFiles_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var file = (GISharp.Lib.Gio.IFile)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)file_, GISharp.Runtime.Transfer.None)!;
                        var result = (GISharp.Lib.Gio.IAsyncResult)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)result_, GISharp.Runtime.Transfer.None)!;
                        var doMeasureDiskUsageFinish = (_MeasureDiskUsageFinish)methodInfo.CreateDelegate(typeof(_MeasureDiskUsageFinish), file);
                        doMeasureDiskUsageFinish(result,out var diskUsage,out var numDirs,out var numFiles);
                        *diskUsage_ = (ulong)diskUsage;
                        *numDirs_ = (ulong)numDirs;
                        *numFiles_ = (ulong)numFiles;
                        return GISharp.Runtime.Boolean.True;
                    }
                    catch (GISharp.Lib.GLib.Error.Exception ex)
                    {
