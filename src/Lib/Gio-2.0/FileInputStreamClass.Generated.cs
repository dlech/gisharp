...
GISharp.Lib.Gio.FileInputStream.UnmanagedStruct* stream);
        ...
        public static unsafe class TellMarshal
        {
            ...
            {
                long unmanagedTell(GISharp.Lib.Gio.FileInputStream.UnmanagedStruct* stream_) { try { var stream = GISharp.Lib.Gio.FileInputStream.GetInstance<GISharp.Lib.Gio.FileInputStream>((System.IntPtr)stream_, GISharp.Runtime.Transfer.None)!; var doTell = (_Tell)methodInfo.CreateDelegate(typeof(_Tell), stream); var ret = doTell(); var ret_ = (long)ret; return ret_; } catch (System.Exception ex) { GISharp.Runtime.GMarshal.PushUnhandledException(ex); } return default(long); }
