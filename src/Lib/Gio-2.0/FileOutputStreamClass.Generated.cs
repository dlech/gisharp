...
GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* stream);
        ...
        public static unsafe class TellMarshal
        {
            ...
            {
                long unmanagedTell(GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* stream_)
                {
                    try
                    {
                        var stream = GISharp.Lib.Gio.FileOutputStream.GetInstance<GISharp.Lib.Gio.FileOutputStream>((System.IntPtr)stream_, GISharp.Runtime.Transfer.None)!;
                        var doTell = (_Tell)methodInfo.CreateDelegate(typeof(_Tell), stream);
                        var ret = doTell();
                        var ret_ = (long)ret;
                        return ret_;
                    }
...
GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* stream);
        ...
        public static unsafe class CanSeekMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedCanSeek(GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* stream_)
                {
                    try
                    {
                        var stream = GISharp.Lib.Gio.FileOutputStream.GetInstance<GISharp.Lib.Gio.FileOutputStream>((System.IntPtr)stream_, GISharp.Runtime.Transfer.None)!;
                        var doCanSeek = (_CanSeek)methodInfo.CreateDelegate(typeof(_CanSeek), stream);
                        var ret = doCanSeek();
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class SeekMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedSeek(GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* stream_, long offset_, GISharp.Lib.GLib.SeekType type_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var stream = GISharp.Lib.Gio.FileOutputStream.GetInstance<GISharp.Lib.Gio.FileOutputStream>((System.IntPtr)stream_, GISharp.Runtime.Transfer.None)!;
                        ...
                        var doSeek = (_Seek)methodInfo.CreateDelegate(typeof(_Seek), stream);
...
GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* stream);
        ...
        public static unsafe class CanTruncateMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedCanTruncate(GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* stream_)
                {
                    try
                    {
                        var stream = GISharp.Lib.Gio.FileOutputStream.GetInstance<GISharp.Lib.Gio.FileOutputStream>((System.IntPtr)stream_, GISharp.Runtime.Transfer.None)!;
                        var doCanTruncate = (_CanTruncate)methodInfo.CreateDelegate(typeof(_CanTruncate), stream);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class TruncateFnMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedTruncateFn(GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* stream_, long size_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var stream = GISharp.Lib.Gio.FileOutputStream.GetInstance<GISharp.Lib.Gio.FileOutputStream>((System.IntPtr)stream_, GISharp.Runtime.Transfer.None)!;
                        var size = (long)size_;
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doTruncateFn = (_TruncateFn)methodInfo.CreateDelegate(typeof(_TruncateFn), stream);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class QueryInfoMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileInfo.UnmanagedStruct* unmanagedQueryInfo(GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* stream_, byte* attributes_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var stream = GISharp.Lib.Gio.FileOutputStream.GetInstance<GISharp.Lib.Gio.FileOutputStream>((System.IntPtr)stream_, GISharp.Runtime.Transfer.None)!;
            ...
            public static UnmanagedQueryInfoAsync Create(System.Reflection.MethodInfo methodInfo)
            {
                void unmanagedQueryInfoAsync(GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* stream_, byte* attributes_, int ioPriority_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, delegate* unmanaged[Cdecl]<GISharp.Lib.GObject.Object.UnmanagedStruct*, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct*, System.IntPtr, void> callback_, System.IntPtr userData_)
                {
                    try
                    {
                        ...
                        var cancellable = GISharp.Lib.Gio.Cancellable.GetInstance<GISharp.Lib.Gio.Cancellable>((System.IntPtr)cancellable_, GISharp.Runtime.Transfer.None);
                        var doQueryInfoAsync = (_QueryInfoAsync)methodInfo.CreateDelegate(typeof(_QueryInfoAsync), stream);
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class QueryInfoFinishMarshal
        {
            ...
            {
                GISharp.Lib.Gio.FileInfo.UnmanagedStruct* unmanagedQueryInfoFinish(GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* stream_, GISharp.Lib.Gio.AsyncResult.UnmanagedStruct* result_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var stream = GISharp.Lib.Gio.FileOutputStream.GetInstance<GISharp.Lib.Gio.FileOutputStream>((System.IntPtr)stream_, GISharp.Runtime.Transfer.None)!;
                        ...
                        var doQueryInfoFinish = (_QueryInfoFinish)methodInfo.CreateDelegate(typeof(_QueryInfoFinish), stream);
        ...
        public delegate GISharp.Runtime.Utf8? _GetEtag();
...
GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* stream);
        ...
        public static unsafe class GetEtagMarshal
        {
            ...
            {
                byte* unmanagedGetEtag(GISharp.Lib.Gio.FileOutputStream.UnmanagedStruct* stream_)
                {
                    try
                    {
                        var stream = GISharp.Lib.Gio.FileOutputStream.GetInstance<GISharp.Lib.Gio.FileOutputStream>((System.IntPtr)stream_, GISharp.Runtime.Transfer.None)!;
                        var doGetEtag = (_GetEtag)methodInfo.CreateDelegate(typeof(_GetEtag), stream);
                        var ret = doGetEtag();
