...
/* <type name="Initable" type="GInitable*" is-pointer="1" /> */
...
GISharp.Lib.GLib.Error.UnmanagedStruct** error);
        ...
        public static unsafe class InitMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedInit(GISharp.Lib.Gio.Initable.UnmanagedStruct* initable_, GISharp.Lib.Gio.Cancellable.UnmanagedStruct* cancellable_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
                {
                    try
                    {
                        var initable = (GISharp.Lib.Gio.IInitable)GISharp.Lib.GObject.Object.GetInstance((System.IntPtr)initable_, GISharp.Runtime.Transfer.None)!;
                        ...
                        var doInit = (_Init)methodInfo.CreateDelegate(typeof(_Init), initable);
                        doInit(cancellable);
