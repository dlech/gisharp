...
GISharp.Lib.Gio.FileIOStream.UnmanagedStruct* stream);
        ...
        public static unsafe class TellMarshal
        {
            ...
            {
                long unmanagedTell(GISharp.Lib.Gio.FileIOStream.UnmanagedStruct* stream_) { try { var stream = GISharp.Lib.Gio.FileIOStream.GetInstance<GISharp.Lib.Gio.FileIOStream>((System.IntPtr)stream_, GISharp.Runtime.Transfer.None)!; var doTell = (_Tell)methodInfo.CreateDelegate(typeof(_Tell), stream); var ret = doTell(); var ret_ = (long)ret; return ret_; } catch (System.Exception ex) { GISharp.Runtime.GMarshal.LogUnhandledException(ex); } return default(long); }
...
GISharp.Lib.Gio.FileIOStream.UnmanagedStruct* stream);
        ...
        public static unsafe class GetEtagMarshal
        {
            ...
            {
                byte* unmanagedGetEtag(GISharp.Lib.Gio.FileIOStream.UnmanagedStruct* stream_) { try { var stream = GISharp.Lib.Gio.FileIOStream.GetInstance<GISharp.Lib.Gio.FileIOStream>((System.IntPtr)stream_, GISharp.Runtime.Transfer.None)!; var doGetEtag = (_GetEtag)methodInfo.CreateDelegate(typeof(_GetEtag), stream); var ret = doGetEtag(); var ret_ = (byte*)ret.Take(); return ret_; } catch (System.Exception ex) { GISharp.Runtime.GMarshal.LogUnhandledException(ex); } return default(byte*); }
