...
GISharp.Lib.Gio.IOStream.UnmanagedStruct* stream);
        ...
        public static unsafe class GetInputStreamMarshal
        {
            ...
            {
                GISharp.Lib.Gio.InputStream.UnmanagedStruct* unmanagedGetInputStream(GISharp.Lib.Gio.IOStream.UnmanagedStruct* stream_) { try { var stream = GISharp.Lib.Gio.IOStream.GetInstance<GISharp.Lib.Gio.IOStream>((System.IntPtr)stream_, GISharp.Runtime.Transfer.None)!; var doGetInputStream = (_GetInputStream)methodInfo.CreateDelegate(typeof(_GetInputStream), stream); var ret = doGetInputStream(); var ret_ = (GISharp.Lib.Gio.InputStream.UnmanagedStruct*)ret.UnsafeHandle; return ret_; } catch (System.Exception ex) { GISharp.Runtime.GMarshal.PushUnhandledException(ex); } return default(GISharp.Lib.Gio.InputStream.UnmanagedStruct*); }
...
GISharp.Lib.Gio.IOStream.UnmanagedStruct* stream);
        ...
        public static unsafe class GetOutputStreamMarshal
        {
            ...
            {
                GISharp.Lib.Gio.OutputStream.UnmanagedStruct* unmanagedGetOutputStream(GISharp.Lib.Gio.IOStream.UnmanagedStruct* stream_) { try { var stream = GISharp.Lib.Gio.IOStream.GetInstance<GISharp.Lib.Gio.IOStream>((System.IntPtr)stream_, GISharp.Runtime.Transfer.None)!; var doGetOutputStream = (_GetOutputStream)methodInfo.CreateDelegate(typeof(_GetOutputStream), stream); var ret = doGetOutputStream(); var ret_ = (GISharp.Lib.Gio.OutputStream.UnmanagedStruct*)ret.UnsafeHandle; return ret_; } catch (System.Exception ex) { GISharp.Runtime.GMarshal.PushUnhandledException(ex); } return default(GISharp.Lib.Gio.OutputStream.UnmanagedStruct*); }
