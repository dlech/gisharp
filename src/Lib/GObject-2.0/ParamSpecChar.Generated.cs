...
#pragma warning restore CS0169, CS0414, CS0649
        ...
        static partial void CheckNewArgs(GISharp.Lib.GLib.UnownedUtf8 name, GISharp.Lib.GLib.UnownedUtf8 nick, GISharp.Lib.GLib.UnownedUtf8 blurb, sbyte minimum, sbyte maximum, sbyte defaultValue, GISharp.Lib.GObject.ParamFlags flags);

        static GISharp.Lib.GObject.ParamSpec.UnmanagedStruct* New(GISharp.Lib.GLib.UnownedUtf8 name, GISharp.Lib.GLib.UnownedUtf8 nick, GISharp.Lib.GLib.UnownedUtf8 blurb, sbyte minimum, sbyte maximum, sbyte defaultValue, GISharp.Lib.GObject.ParamFlags flags)
        {
        ...
        /// <include file="ParamSpecChar.xmldoc" path="declaration/member[@name='ParamSpecChar.ParamSpecChar(GISharp.Lib.GLib.UnownedUtf8,GISharp.Lib.GLib.UnownedUtf8,GISharp.Lib.GLib.UnownedUtf8,sbyte,sbyte,sbyte,GISharp.Lib.GObject.ParamFlags)']/*" />
