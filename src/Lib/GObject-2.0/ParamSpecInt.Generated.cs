...
#pragma warning restore CS0169, CS0414, CS0649
        ...
        static partial void CheckNewArgs(GISharp.Runtime.UnownedUtf8 name, GISharp.Runtime.UnownedUtf8 nick, GISharp.Runtime.UnownedUtf8 blurb, int minimum, int maximum, int defaultValue, GISharp.Lib.GObject.ParamFlags flags);

        static GISharp.Lib.GObject.ParamSpec.UnmanagedStruct* New(GISharp.Runtime.UnownedUtf8 name, GISharp.Runtime.UnownedUtf8 nick, GISharp.Runtime.UnownedUtf8 blurb, int minimum, int maximum, int defaultValue, GISharp.Lib.GObject.ParamFlags flags)
        {
        ...
        /// <include file="ParamSpecInt.xmldoc" path="declaration/member[@name='ParamSpecInt.ParamSpecInt(GISharp.Runtime.UnownedUtf8,GISharp.Runtime.UnownedUtf8,GISharp.Runtime.UnownedUtf8,int,int,int,GISharp.Lib.GObject.ParamFlags)']/*" />
        public ParamSpecInt(GISharp.Runtime.UnownedUtf8 name, GISharp.Runtime.UnownedUtf8 nick, GISharp.Runtime.UnownedUtf8 blurb, int minimum, int maximum, int defaultValue, GISharp.Lib.GObject.ParamFlags flags) : this((System.IntPtr)New(name, nick, blurb, minimum, maximum, defaultValue, flags), GISharp.Runtime.Transfer.None)
        {
        }
    }
}