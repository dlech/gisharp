...
#pragma warning restore CS0169, CS0414, CS0649
        ...
        static partial void CheckNewArgs(GISharp.Runtime.UnownedUtf8 name, GISharp.Runtime.UnownedUtf8 nick, GISharp.Runtime.UnownedUtf8 blurb, GISharp.Runtime.GType boxedType, GISharp.Lib.GObject.ParamFlags flags);

        static GISharp.Lib.GObject.ParamSpec.UnmanagedStruct* New(GISharp.Runtime.UnownedUtf8 name, GISharp.Runtime.UnownedUtf8 nick, GISharp.Runtime.UnownedUtf8 blurb, GISharp.Runtime.GType boxedType, GISharp.Lib.GObject.ParamFlags flags)
        {
        ...
        /// <include file="ParamSpecBoxed.xmldoc" path="declaration/member[@name='ParamSpecBoxed.ParamSpecBoxed(GISharp.Runtime.UnownedUtf8,GISharp.Runtime.UnownedUtf8,GISharp.Runtime.UnownedUtf8,GISharp.Runtime.GType,GISharp.Lib.GObject.ParamFlags)']/*" />
        public ParamSpecBoxed(GISharp.Runtime.UnownedUtf8 name, GISharp.Runtime.UnownedUtf8 nick, GISharp.Runtime.UnownedUtf8 blurb, GISharp.Runtime.GType boxedType, GISharp.Lib.GObject.ParamFlags flags) : this((System.IntPtr)New(name, nick, blurb, boxedType, flags), GISharp.Runtime.Transfer.None)
        {
        }
    }
}