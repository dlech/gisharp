...
GISharp.Lib.GObject.ParamSpec.UnmanagedStruct* pspec);
        ...
        public static unsafe class FinalizeMarshal
        {
            ...
            {
                void unmanagedFinalize(GISharp.Lib.GObject.ParamSpec.UnmanagedStruct* pspec_)
                {
                    try
                    {
                        ...
                        var doFinalize = (_Finalize)methodInfo.CreateDelegate(typeof(_Finalize), pspec);
                        doFinalize();
                    }
...
GISharp.Lib.GObject.Value* value);
        ...
        public static unsafe class ValueSetDefaultMarshal
        {
            ...
            {
                void unmanagedValueSetDefault(GISharp.Lib.GObject.ParamSpec.UnmanagedStruct* pspec_, GISharp.Lib.GObject.Value* value_)
                {
                    try
                    {
                        var pspec = GISharp.Lib.GObject.ParamSpec.GetInstance<GISharp.Lib.GObject.ParamSpec>((System.IntPtr)pspec_, GISharp.Runtime.Transfer.None)!;
                        ref var value = ref System.Runtime.CompilerServices.Unsafe.AsRef<GISharp.Lib.GObject.Value>(value_);
                        var doValueSetDefault = (_ValueSetDefault)methodInfo.CreateDelegate(typeof(_ValueSetDefault), pspec);
                        doValueSetDefault(ref value);
                    }
                    catch (System.Exception ex)
                    {
                        GISharp.Runtime.GMarshal.PushUnhandledException(ex);
...
GISharp.Lib.GObject.Value* value);
        ...
        public static unsafe class ValueValidateMarshal
        {
            ...
            {
                GISharp.Runtime.Boolean unmanagedValueValidate(GISharp.Lib.GObject.ParamSpec.UnmanagedStruct* pspec_, GISharp.Lib.GObject.Value* value_)
                {
                    try
                    {
                        var pspec = GISharp.Lib.GObject.ParamSpec.GetInstance<GISharp.Lib.GObject.ParamSpec>((System.IntPtr)pspec_, GISharp.Runtime.Transfer.None)!;
                        ref var value = ref System.Runtime.CompilerServices.Unsafe.AsRef<GISharp.Lib.GObject.Value>(value_);
                        var doValueValidate = (_ValueValidate)methodInfo.CreateDelegate(typeof(_ValueValidate), pspec);
                        var ret = doValueValidate(ref value);
...
GISharp.Lib.GObject.Value* value2);
        ...
        public static unsafe class ValuesCmpMarshal
        {
            ...
            {
                int unmanagedValuesCmp(GISharp.Lib.GObject.ParamSpec.UnmanagedStruct* pspec_, GISharp.Lib.GObject.Value* value1_, GISharp.Lib.GObject.Value* value2_)
                {
                    try
                    {
                        var pspec = GISharp.Lib.GObject.ParamSpec.GetInstance<GISharp.Lib.GObject.ParamSpec>((System.IntPtr)pspec_, GISharp.Runtime.Transfer.None)!;
                        ref var value1 = ref System.Runtime.CompilerServices.Unsafe.AsRef<GISharp.Lib.GObject.Value>(value1_);
                        ref var value2 = ref System.Runtime.CompilerServices.Unsafe.AsRef<GISharp.Lib.GObject.Value>(value2_);
                        var doValuesCmp = (_ValuesCmp)methodInfo.CreateDelegate(typeof(_ValuesCmp), pspec);
                        var ret = doValuesCmp(value1, value2);
                        var ret_ = (int)ret;
                        return ret_;
                    }
                    catch (System.Exception ex)
