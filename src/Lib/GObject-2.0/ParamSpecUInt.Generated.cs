...
#pragma warning restore CS0169, CS0414, CS0649
        ...
        static partial void CheckNewArgs(GISharp.Lib.GLib.UnownedUtf8 name, GISharp.Lib.GLib.UnownedUtf8 nick, GISharp.Lib.GLib.UnownedUtf8 blurb, uint minimum, uint maximum, uint defaultValue, GISharp.Lib.GObject.ParamFlags flags);

        static GISharp.Lib.GObject.ParamSpec.UnmanagedStruct* New(GISharp.Lib.GLib.UnownedUtf8 name, GISharp.Lib.GLib.UnownedUtf8 nick, GISharp.Lib.GLib.UnownedUtf8 blurb, uint minimum, uint maximum, uint defaultValue, GISharp.Lib.GObject.ParamFlags flags)
        {
        ...
        /// <include file="ParamSpecUInt.xmldoc" path="declaration/member[@name='ParamSpecUInt.ParamSpecUInt(GISharp.Lib.GLib.UnownedUtf8,GISharp.Lib.GLib.UnownedUtf8,GISharp.Lib.GLib.UnownedUtf8,uint,uint,uint,GISharp.Lib.GObject.ParamFlags)']/*" />
        public ParamSpecUInt(GISharp.Lib.GLib.UnownedUtf8 name, GISharp.Lib.GLib.UnownedUtf8 nick, GISharp.Lib.GLib.UnownedUtf8 blurb, uint minimum, uint maximum, uint defaultValue, GISharp.Lib.GObject.ParamFlags flags) : this((System.IntPtr)New(name, nick, blurb, minimum, maximum, defaultValue, flags), GISharp.Runtime.Transfer.None)
        {
        }
    }
}