...
namespace GISharp.Lib.GLib
{
    partial class DBusObjectPath
    {
        ...
        /// </summary>
        public DBusObjectPath(UnownedUtf8 path) : this(Validate(path), path.MaybeLength, Transfer.None)
        {
        }
        ...
        public DBusObjectPath(IntPtr handle, int length, Transfer ownership) : base(handle, length, ownership)
        {
        }
    }
}
