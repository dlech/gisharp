...
namespace GISharp.Lib.GLib
{
    unsafe partial class OptionGroup
    {
        ...
        static UnmanagedStruct* New(
            UnownedUtf8 name,
            UnownedUtf8 description,
            UnownedUtf8 helpDescription,
        ...
        )
        {
            ...
            var postParseFunc_ = (delegate* unmanaged[Cdecl]<
                OptionContext.UnmanagedStruct*,
                UnmanagedStruct*,
                IntPtr,
                Error.UnmanagedStruct**,
                Runtime.Boolean>)
                &OnParsed;
        ...
        private OptionGroup(IntPtr handle, UserData userData)
            : base(handle)
        {
        ...
        )
        {
            ...
            var argDescription_ = AllocString(
                argDescription ?? throw new ArgumentNullException(nameof(argDescription))
            );
        ...
        /// </summary>
        public void AddFilenameArray(
            string longName,
            char shortName,
            Action<Strv<Filename>> callback,
            string description,
            string argDescription,
            OptionFlags flags = OptionFlags.None
        )
        ...
        )
        {
            ...
            var wrappedCallback = new UnmanagedOptionArgFunc(
                (optionName_, value_, data_, error_) =>
                {
                    try
                    {
        ...
        [UnmanagedCallersOnly(CallConvs = new[] { typeof(CallConvCdecl) })]
        static Runtime.Boolean OnParsed(
            OptionContext.UnmanagedStruct* context_,
            UnmanagedStruct* group_,
            IntPtr data_,
