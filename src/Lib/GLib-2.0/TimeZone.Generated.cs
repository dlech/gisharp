...
namespace GISharp.Lib.GLib
{
    ...
    public sealed unsafe partial class TimeZone : GISharp.Runtime.Boxed
    {
        ...
        private static extern GISharp.Lib.GLib.TimeZone.UnmanagedStruct* g_time_zone_new_identifier(
        /* <type name="utf8" type="const gchar*" is-pointer="1" /> */
        /* transfer-ownership:none nullable:1 allow-none:1 direction:in */
        byte* identifier);
        static partial void CheckGetIdentifierArgs(GISharp.Runtime.NullableUnownedUtf8 identifier);

        /// <include file="TimeZone.xmldoc" path="declaration/member[@name='TimeZone.GetIdentifier(GISharp.Runtime.NullableUnownedUtf8)']/*" />
        [GISharp.Runtime.SinceAttribute("2.68")]
        public static GISharp.Lib.GLib.TimeZone? GetIdentifier(GISharp.Runtime.NullableUnownedUtf8 identifier)
        {
            CheckGetIdentifierArgs(identifier);
            var identifier_ = (byte*)identifier.UnsafeHandle;
            var ret_ = g_time_zone_new_identifier(identifier_);
            GISharp.Runtime.GMarshal.PopUnhandledException();
