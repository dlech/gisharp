    ...
    public static class FileMeasureProgressCallbackMarshal
    {
        ...
        public static GISharp.Lib.Gio.FileMeasureProgressCallback FromPointer(System.IntPtr callback_, System.IntPtr userData_)
        {
            ...
            unsafe void managedCallback(System.Boolean reporting, System.UInt64 currentSize, System.UInt64 numDirs, System.UInt64 numFiles)
            {
                ...
                unmanagedCallback(reporting_, currentSize_, numDirs_, numFiles_, userData_);
            }
        ...
        /// </remarks>
        public static unsafe (System.IntPtr callback_, System.IntPtr notify_, System.IntPtr userData_) ToPointer(GISharp.Lib.Gio.FileMeasureProgressCallback? callback, GISharp.Runtime.CallbackScope scope)
        {
            if (callback == null)
            {
                return default;
