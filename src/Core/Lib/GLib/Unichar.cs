...
namespace GISharp.Lib.GLib
{
    ...
    public struct Unichar : IEquatable<Unichar>, IEquatable<uint>, IEquatable<int>, IEquatable<Rune>
    {
        ...
        /// <summary>
        /// The maximum length (in code points) of a compatibility or canonical
        ...
        /// </returns>
        [DllImport("glib-2.0", CallingConvention = CallingConvention.Cdecl)]
        /* <type name="gint" type="gint" managed-name="int" /> */
        /* transfer-ownership:none */
        static extern int g_unichar_xdigit_value(
            /* <type name="gunichar" type="gunichar" managed-name="Unichar" /> */
            /* transfer-ownership:none */
            Unichar c);
