...
namespace GISharp.Lib.GLib
{
    ...
    public static class OptionParseFuncMarshal
    {
        ...
        /// </remarks>
        public static unsafe (System.IntPtr callback_, System.IntPtr notify_, System.IntPtr userData_) ToUnmanagedFunctionPointer(GISharp.Lib.GLib.OptionParseFunc? callback, GISharp.Runtime.CallbackScope scope)
        {
            if (callback == null)
            {
                return default;
        ...
        static unsafe GISharp.Runtime.Boolean UnmanagedCallback(GISharp.Lib.GLib.OptionContext.UnmanagedStruct* context_, GISharp.Lib.GLib.OptionGroup.UnmanagedStruct* group_, System.IntPtr data_, GISharp.Lib.GLib.Error.UnmanagedStruct** error_)
        {
            try
            {
        ...
        static readonly unsafe GISharp.Lib.GLib.UnmanagedOptionParseFunc UnmanagedCallbackDelegate = UnmanagedCallback;
