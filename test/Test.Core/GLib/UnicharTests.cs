...
namespace GISharp.Test.Core
{
    ...
    public class UnicharTests
    {
        ...
        {
            Assert.That(Marshal.SizeOf<Unichar>(), Is.EqualTo(sizeof(int)));
        }
        ...
        {
            var c = new Unichar(0x0041); // A
            Assert.That(c.IsLowercase, Is.False);
            c = new Unichar(0x0061); // a
            Assert.That(c.IsLowercase, Is.True);
            AssertNoGLibLog();
        }
        ...
        public void TestIsTitle()
        {
            ...
            Assert.That(c.IsTitlecase, Is.True);
            c = new Unichar(0x0041); // A
            Assert.That(c.IsTitlecase, Is.False);
            AssertNoGLibLog();
        }
        ...
        public void TestIsUpper()
        {
            ...
            Assert.That(c.IsUppercase, Is.False);
            c = new Unichar(0x0041); // A
            Assert.That(c.IsUppercase, Is.True);
            AssertNoGLibLog();
        }
        ...
        {
            var c = new Unichar(0x0061); // a
            Assert.That(c.ToUppercase(), Is.EqualTo(new Unichar(0x0041))); // A
            AssertNoGLibLog();
        }
        ...
        {
            var c = new Unichar(0x0041); // A
            Assert.That(c.ToLowercase(), Is.EqualTo(new Unichar(0x0061))); // a
            AssertNoGLibLog();
        }
        ...
        {
            var c = new Unichar(0x0061); // a
            Assert.That(c.ToTitlecase(), Is.EqualTo(new Unichar(0x0041))); // A
            AssertNoGLibLog();
        }
        ...
        public void TestCompose()
        {
            ...
            Assert.That(Unichar.TryCompose(a, b, out var c), Is.True);
        ...
        {
            var c = new Unichar(0x0061); // a
            Assert.That(c.Script, Is.EqualTo(UnicodeScript.Latin));
            AssertNoGLibLog();
        }

        [Test]
        public void TesToUtf8()
        {
            var c = new Unichar(0x0061); // a
