...
namespace GISharp.Lib.Gio
{
    ...
    /// <see cref="Action.Activate"/>.  This results in the 'activate' signal being
    /// emitted.  An activation has a #GVariant parameter (which may be
    /// <c>null</c>).  The correct type for the parameter is determined by a static
    /// parameter type (which is given at construction time).
    /// 
    /// An action may optionally have a state, in which case the state may be
    /// set with <see cref="Action.ChangeState"/>.  This call takes a #GVariant.  The
    ...
    /// calls to <see cref="Action.Activate"/> and <see cref="Action.ChangeState"/> for type
    ...
    public partial interface IAction : GISharp.Runtime.GInterface<GISharp.Lib.GObject.Object>
    {
        ...
        /// </summary>
        /// <remarks>
        /// When activating the action using <see cref="Action.Activate"/>, the #GVariant
        ...
        /// given by <see cref="Action.GetStateType"/>.
        /// 
        ...
        /// given as the state. All calls to <see cref="Action.ChangeState"/> must give a
        /// #GVariant of this type and <see cref="Action.GetState"/> will return a
        /// #GVariant of the same type.
        /// 
        /// If the action is not stateful (e.g. created with <see cref="SimpleAction.New"/>)
        /// then this function will return <c>null</c>. In that case, <see cref="Action.GetState"/>
        /// will return <c>null</c> and you must not call <see cref="Action.ChangeState"/>.
        /// </remarks>
        /// <returns>
