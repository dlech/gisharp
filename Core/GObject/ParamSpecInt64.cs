...
#pragma warning restore CS0649
        ...
        public ParamSpecInt64 (SafeHandle handle) : base (handle)
        {
        }
        ...
        static SafeHandle New (string name, string nick, string blurb, long min, long max, long defaultValue, ParamFlags flags)
        {
            if (name == null) {
