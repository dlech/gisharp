        ...
        public static IEnumerable<(string name, CompilationUnitSyntax unit)> GetCompilationUnits(this Repository repository)
        {
            ...
            foreach (var type in repository.Namespace.AllTypes) {
                var unit = CompilationUnit()
                    .AddMembers(@namespace.WithMembers(repository.Namespace.GetMembersFor(type)))
                    .WithLeadingTrivia(Comment("// ATTENTION: This file is automatically generated. Do not edit manually."),
                        EndOfLine("\n"),
                        ParseLeadingTrivia("#nullable enable").Single(),
                        // Trivia(NullableDirectiveTrivia(Token(EnableKeyword), false)),
                        EndOfLine("\n"));
