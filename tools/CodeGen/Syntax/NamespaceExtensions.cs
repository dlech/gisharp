...
namespace GISharp.CodeGen.Syntax
{
    public static class NamespaceExtensions
    {
        ...
        static IEnumerable<MemberDeclarationSyntax> GetDeclarations(GIBase type)
        {
            ...
            switch (type)
            {
                case Alias alias:
                    if (alias.Type.Interface is Callback aliasCallback)
                    {
                        ...
                        if (!aliasCallback.IsPInvokeOnly)
                        {
                            ...
                            yield return aliasCallback
                                .GetDelegateMarshalDeclaration(alias.GirName)
                                .WithMembers(
                                    aliasCallback.GetCallbackDelegateMarshalClassMembers(
                                        alias.GirName
                                    )
                                );
                        }
                ...
                case Bitfield bitfield:
                    ...
                    {
                        yield return bitfield
                            .GetExtClassDeclaration()
                            .WithMembers(extensionMembers);
                    }
                    break;
                case Boxed boxed:
                    yield return boxed.GetClassDeclaration().WithMembers(boxed.GetClassMembers());
                    break;
                case Callback callback:
                    ...
                    break;
                case Class @class:
                    yield return @class.GetClassDeclaration().WithMembers(@class.GetClassMembers());
                    break;
                ...
                case Record record:
                    ...
                    {
                        yield return record
                            .GetGTypeStructClassDeclaration()
                ...
                case StaticClass staticClass:
                    ...
                    break;
                case Union union:
                    yield return union.GetStructDeclaration().WithMembers(union.GetStructMembers());
                    break;
                default:
        ...
        /// </summary>
        public static SyntaxList<MemberDeclarationSyntax> GetMembersFor(
